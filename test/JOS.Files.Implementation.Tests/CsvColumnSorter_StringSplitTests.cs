...
{
    public class CsvColumnSorter_StringSplitTests
    {
        ...
        private readonly CsvColumnSorter_StringSplit _sut;

        public CsvColumnSorter_StringSplitTests()
        {
            _sut = new CsvColumnSorter_StringSplit(2);
        }
